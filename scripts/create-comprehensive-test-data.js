...
// Comprehensive test data with all categories
const testNominations = [
  // Role-Specific - Person nominations
  {
    type: 'person',
  ...
  },
  {
    ...
    nominator_name: 'James Smith',
    nominator_email: 'james.smith@innovaterecruit.com',
    nominator_company: 'InnovateRecruit',
    nominator_job_title: 'CTO',
    votes: 52
  },
  {
    type: 'person',
    ...
    nominator_name: 'Rachel Green',
    nominator_email: 'rachel.green@futurestaffing.com',
    nominator_company: 'Future Staffing',
    nominator_job_title: 'Senior Manager',
    votes: 29
  },
  ...
  // Company Awards
  {
    ...
    nominator_name: 'Jennifer Davis',
    nominator_email: 'jennifer.davis@client.com',
    nominator_company: 'Client Corp',
    nominator_job_title: 'HR Director',
    votes: 67
  },
  {
    type: 'company',
    ...
    nominator_name: 'Robert Kim',
    nominator_email: 'robert.kim@techstartup.com',
    nominator_company: 'Tech Startup Inc',
    nominator_job_title: 'Founder',
    votes: 43
  },
  {
    type: 'company',
    ...
    nominator_name: 'Maria Gonzalez',
    nominator_email: 'maria.gonzalez@diversetech.com',
    nominator_company: 'DiverseTech',
    nominator_job_title: 'Chief Diversity Officer',
    votes: 56
  },

  // Some pending nominations for admin testing
  {
    type: 'person',
    subcategory_id: 'top-recruiter',
    state: 'submitted',
    ...
    nominator_name: 'Susan Lee',
    nominator_email: 'susan.lee@staffingpro.com',
    nominator_company: 'StaffingPro',
    nominator_job_title: 'Manager',
    votes: 0
  },
  {
    type: 'company',
    ...
    nominator_name: 'Tom Wilson',
    nominator_email: 'tom.wilson@client.com',
    nominator_company: 'Client Solutions',
    nominator_job_title: 'VP Operations',
    votes: 0
  },

  // Some rejected nominations for admin testing
  {
    type: 'person',
    subcategory_id: 'talent-acquisition-leader',
    state: 'rejected',
    ...
    nominator_company: 'Example Corp',
    nominator_job_title: 'HR',
    votes: 0
  }
];
