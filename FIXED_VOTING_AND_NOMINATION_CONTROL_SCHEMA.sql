-- Fixed Enhanced Voting and Nomination Control Schema
...
-- 11. Comments
COMMENT ON TABLE public.admin_nominations_table IS 'Admin-created nominations that bypass the normal approval process';
COMMENT ON VIEW public.admin_nominations IS 'View for backward compatibility with admin nominations';
