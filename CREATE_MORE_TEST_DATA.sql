-- Create More Test Data for Individual Nominee Pages
...
-- Create nominations for the new nominees (linking them to nominators)
-- Person nominations
...
FROM public.nominators n
CROSS JOIN public.nominees ne
WHERE ne.type = 'person' 
  AND ne.firstname IN ('Jessica', 'Robert', 'Lisa', 'James', 'Maria', 'Alex')
  AND n.email IN ('sarah.johnson@techcorp.com', 'michael.chen@globalhr.com', 'emma.williams@startupinc.com', 'david.brown@recruitpro.au', 'lisa.garcia@hrexcellence.com')
LIMIT 6;
