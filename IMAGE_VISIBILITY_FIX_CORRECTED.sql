...
-- 5. Simple verification query (no DO block)
-- Run this separately to check results:
-- SELECT 
--   COUNT(*) as total_nominees,
--   COUNT(image_url) as nominees_with_images,
--   COUNT(*) - COUNT(image_url) as nominees_without_images
-- FROM public.public_nominees;

-- Success message
SELECT 'Image visibility fix applied successfully!' as status;