-- Fixed Theme Customization System Schema
...
CREATE TABLE IF NOT EXISTS theme_settings (
  ...
  color_value VARCHAR(10) NOT NULL, -- Increased to support 8-char hex + alpha
...
('cards', 'default', 'shadow', '#0000001a', '#0000001a', 'Default card shadow'),
...
-- Logo Settings
('branding', 'logo', 'header', '/logo.png', '/logo.png', 'Header logo image URL'),
('branding', 'logo', 'footer', '/logo.png', '/logo.png', 'Footer logo image URL'),
('branding', 'logo', 'alt', 'Logo', 'Logo', 'Logo alt text')
