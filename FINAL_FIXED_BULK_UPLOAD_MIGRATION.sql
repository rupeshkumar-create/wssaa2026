-- FINAL FIXED Bulk Upload Migration Script
-- This script handles all edge cases and existing schema conflicts
-- Run this step by step to avoid any conflicts

-- =====================================================
-- STEP 1: CHECK AND HANDLE EXISTING APP_SETTINGS
-- =====================================================

-- First, check if app_settings exists as a view and drop it if needed
DO $$
BEGIN
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.check_constraints 
        ...
        ADD CONSTRAINT bulk_upload_batches_status_check 
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
        ...
        ALTER TABLE bulk_upload_errors 
        ADD CONSTRAINT bulk_upload_errors_batch_id_fkey 
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
        ...
        ALTER TABLE loops_sync_queue 
        ADD CONSTRAINT loops_sync_queue_nomination_id_fkey 
...
DO $$ 
BEGIN
  RAISE NOTICE '=== FINAL FIXED BULK UPLOAD MIGRATION COMPLETE ===';
  RAISE NOTICE 'All issues have been resolved:';
  RAISE NOTICE '✓ app_settings table created properly (not as view)';
