-- Simple Voting and Nomination Control Schema
...
-- 2. Create admin_nominations_table for admin-only nominations
-- This table will store admin-created nominations separately
